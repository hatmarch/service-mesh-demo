...
----
cdt
cat customer/kubernetes/virtual-service-customer-v1_and_v2.yml

oc apply -f customer/kubernetes/virtual-service-customer-v1_and_v2.yml
----
...
----
cdt
oc apply -f customer/kubernetes/Service-v2-ssl.yml
oc apply -f customer/kubernetes/Route-ssl.yml

# NOTE: route-ssl may have a specific host in it that should be changed
# Turn off Istio Lockdown
oc delete -f scripts/ato-demo-version-03/network-policy.yaml
----
